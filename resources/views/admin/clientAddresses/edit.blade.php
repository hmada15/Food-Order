    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.client-addresses.update", [$clientAddress->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client_id" id="client_id" required>
                    @foreach($clients as $id => $client)
                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') : $clientAddress->client->id ?? '') == $id ? 'selected' : '' }}>{{ $client }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('area') ? 'is-invalid' : '' }}" type="text" name="area" id="area" value="{{ old('area', $clientAddress->area) }}">
                @if($errors->has('area'))
                    <div class="invalid-feedback">
                        {{ $errors->first('area') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_name') ? 'is-invalid' : '' }}" type="text" name="street_name" id="street_name" value="{{ old('street_name', $clientAddress->street_name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('building_type') ? 'is-invalid' : '' }}" name="building_type" id="building_type">
                    ...
                    @foreach(App\Models\ClientAddress::BUILDING_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('building_type', $clientAddress->building_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('building_name') ? 'is-invalid' : '' }}" type="text" name="building_name" id="building_name" value="{{ old('building_name', $clientAddress->building_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('floor_number') ? 'is-invalid' : '' }}" type="text" name="floor_number" id="floor_number" value="{{ old('floor_number', $clientAddress->floor_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apartment_number') ? 'is-invalid' : '' }}" type="text" name="apartment_number" id="apartment_number" value="{{ old('apartment_number', $clientAddress->apartment_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('landmark') ? 'is-invalid' : '' }}" type="text" name="landmark" id="landmark" value="{{ old('landmark', $clientAddress->landmark) }}">
