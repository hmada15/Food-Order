                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                ...
                                @foreach(App\Models\Client::GENDER_RADIO as $key => $item)
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\Client::LANGUAGE_RADIO as $key => $item)
                                    <option value="{{ $item }}">{{ $item }}</option>
                                @endforeach
                            </select>
                        </td>
                ...
                <tbody>
                    @foreach($clients as $key => $client)
                        <tr data-entry-id="{{ $client->id }}">
                            ...
                            <td>
                                {{ App\Models\Client::GENDER_RADIO[$client->gender] ?? '' }}
                            </td>
                            <td>
                                {{ App\Models\Client::LANGUAGE_RADIO[$client->language] ?? '' }}
                            </td>
                            <td>
