            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ProductCategory">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.productCategory.fields.is_publish') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\ProductCategory::IS_PUBLISH_RADIO as $key => $item)
                ...
                <tbody>
                    @foreach($productCategories as $key => $productCategory)
                        <tr data-entry-id="{{ $productCategory->id }}">
                            ...
                            <td>
                                {{ App\Models\ProductCategory::IS_PUBLISH_RADIO[$productCategory->is_publish] ?? '' }}
                            </td>
                            <td>
