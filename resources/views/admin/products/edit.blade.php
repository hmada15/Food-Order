    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sku') ? 'is-invalid' : '' }}" type="number" name="sku" id="sku" value="{{ old('sku', $product->sku) }}" step="1">
                @if($errors->has('sku'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sku') }}
                    </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Product::IN_STOCK_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('in_stock') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="in_stock_{{ $key }}" name="in_stock" value="{{ $key }}" {{ old('in_stock', $product->in_stock) === (string) $key ? 'checked' : '' }} required>
